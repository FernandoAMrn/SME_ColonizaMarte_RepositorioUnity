...
public class Building {
    ...
    public Building(Vector3 position, int ticksToConstruct) {
        ...
        //spriteRenderer.sprite = GameAssets.i.tower_1; AQUI SPRITE DEL JUEGO
    ...
    private void TimeTickSystem_OnTick(object sender, TimeTickSystem.OnTickEventArgs e) {
        if (isConstructing) {
            ...
            //if (buildTickNormalized >=  1f) spriteRenderer.sprite = GameAssets.i.tower_Built;   AQUI SPRITES PARA CONSTRUCCION
